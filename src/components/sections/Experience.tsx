        ...
        <section id="experience" ref={container} className="py-20 px-6 lg:px-20 relative overflow-hidden">
            ...
            <div className="space-y-12 pl-0 md:pl-10">
                {experiences.map((exp, index) => (
                    <div key={index} className="exp-item relative border-l-2 border-slate-700 pl-6 md:border-none md:pl-0 group cursor-default">
                        ...
                        <div className="max-h-0 opacity-0 overflow-hidden group-hover:max-h-[300px] group-hover:opacity-100 transition-all duration-500 ease-in-out">
                            <ul className="space-y-2 border-l border-sky-500/30 pl-4 py-2">
                        ...
                        <div className="text-xs text-slate-600 group-hover:hidden mt-2 font-mono">&lt;hover to expand /&gt;</div>
                    </div>
                ))}
            </div>
        </section>
